...
public class OnlineShoppingTest<ExtentHtmlReporter> {
	WebDriver driver;
  ...
  public void testRegistration() {
	  ...
	  driver.findElement(By.name("userName")).sendKeys("rajanna15");
	  driver.findElement(By.name("firstName")).sendKeys("bhaskarraj");
	  ...
	  if(txt.equals("Available"))
	  {
		  ...
		  driver.findElement(By.name("password")).sendKeys("Rajanna123");
		  driver.findElement(By.name("confirmPassword")).sendKeys("Rajanna123");
